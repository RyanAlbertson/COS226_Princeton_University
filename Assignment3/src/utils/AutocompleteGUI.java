package utils;/* *****************************************************************************
 *  Compilation:  javac-algs4 src.utils.AutocompleteGUI.java
 *  Execution:    java-algs4  src.utils.AutocompleteGUI input.txt k
 *  Dependencies: src.main.Autocomplete.java src.main.Term.java
 *
 ...
 *  @author Kevin Wayne
 *
 *  Interactive GUI used to demonstrate the src.main.Autocomplete data type.
 *
 ...
 *           (to match toString() and output format of target.test client on assignment)
 *
 *  NOTE: Requires Java 7 (or above) because JList was not retrofitted to support
 *        generics until Java 7.
 *
 *
 *  % java-algs4 src.utils.AutocompleteGUI cities.txt 10
 *
 **************************************************************************** */
...
public class AutocompleteGUI extends JFrame {
    ...
    /**
     * Initializes the GUI, and the associated src.main.Autocomplete object
     *
    ...
    public AutocompleteGUI(String filename, int k) {
        ...
        setTitle("src.main.Autocomplete Me");
    ...
    /**
     * The panel that interfaces with the src.main.Autocomplete object.  It consists
    ...
    private class AutocompletePanel extends JPanel {
        ...
        private Autocomplete auto;                // the src.main.Autocomplete object
        ...
        /**
         * Creates the src.main.Autocomplete object and the search bar and suggestion
         * drop-down portions of the GUI
         *
         * @param filename the file the src.main.Autocomplete object is constructed from
         */
        ...
        /**
         * Makes a call to the implementation of src.main.Autocomplete to get
            ...
            if (text.equals("")) {
                ...
                if (Math.min(k, allResults.length) > 0) {
                    for (int i = 0; i < results.length; i++) {
                        ...
                        // A bit of a hack to get the src.main.Term's query string
    ...
    /**
     * Creates an src.utils.AutocompleteGUI object and start it continuously running
     *
     * @param args the filename from which the src.main.Autocomplete object is populated

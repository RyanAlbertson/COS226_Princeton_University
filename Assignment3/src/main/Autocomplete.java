...
public class Autocomplete {
     ...
     *
     * @param terms Array of src.main.Term objects.
     */
    public Autocomplete(Term[] terms) {
        ...
        for (int i = 0; i < terms.length; i++) {
            ...
            // Check for a null src.main.Term.
            if (null == terms[i]) {

                throw new IllegalArgumentException("'terms[src.main.Term]' cannot be null.");
            }
     ...
     *
     * @param prefix A substring to search for within each src.main.Term.
     */
    ...
    public static void main(String[] args) {
        ...
        // Unit target.test located at ~/Tests/AutocompleteTest.java


        // Below is a target.test client taken from the project description.

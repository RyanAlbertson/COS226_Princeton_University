...
public class Term implements Comparable<Term> {
    ...
    /**
     * Constructs a src.main.Term from a given query string and its corresponding weight.
     *
    ...
    /**
     * Implements a comparator that orders the weights of 2 Terms. A src.main.Term is greater
    ...
    /**
     * Returns a comparator that orders src.main.Term objects using weight and sorts
    ...
    /**
     * Returns a comparator that orders src.main.Term objects using a prefixed number of
     * characters starting from the beginning of each src.main.Term. Terms are ordered in
    ...
    /**
     * Returns a lexicographic comparison between 2 src.main.Term objects.
     *
     * @param that The other src.main.Term object to compare with this src.main.Term.
     */
    @Override
    ...
    /**
     * Returns a string representation of this src.main.Term object.
     */
    @Override

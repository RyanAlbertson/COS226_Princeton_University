 ...
 *  Dependencies: main.KdTreeST.java Boid.java Hawk.java
 *
 *  Implementation of a boid simulator using the main.KdTreeST data type,
...
public class BoidSimulator {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // draw the hawk
            StdDraw.setPenRadius(0.04 * (0.5 / radius));
            hawk.draw();
            StdDraw.setPenRadius(0.01 * (0.5 / radius));
            ...
            // allow user to control movement in manual mode
                ...
                if (StdDraw.isKeyPressed(KeyEvent.VK_UP)) { currentY += radius * CAMERA_SPEED; }
                // press "down arrow" to pan downwards
                if (StdDraw.isKeyPressed(KeyEvent.VK_DOWN)) { currentY -= radius * CAMERA_SPEED; }
                // press "left arrow" to pan to the left
                if (StdDraw.isKeyPressed(KeyEvent.VK_LEFT)) { currentX -= radius * CAMERA_SPEED; }
                // press "right arrow" to pan to the right
                if (StdDraw.isKeyPressed(KeyEvent.VK_RIGHT)) { currentX += radius * CAMERA_SPEED; }
            }
            ...
            // lack of balancing in main.KdTreeST.

package utils;/* ******************************************************************************
 *  Compilation:  javac-algs4 src.utils.SCUtility.java
 *  Execution:    none
 *  Dependencies: src.main.SeamCarver.java
 *
 *  Some utility functions for testing src.main.SeamCarver.java.
 *
 **************************************************************************** */
...
public class SCUtility {
    ...
    // convert src.main.SeamCarver picture to width-by-height energy matrix
    ...
    // returns picture of energy matrix associated with src.main.SeamCarver picture

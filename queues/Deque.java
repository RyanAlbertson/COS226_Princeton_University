...
/**
 * Implements a double-ended queue data type, using a doubly linked list.
 *
 * @param <Item> Generic data type to stores in the Deque.
...
public class Deque<Item> implements Iterable<Item> {
    ...
    private class Node {
        ...
        /**
         * Constructor for the first Node (when Deque is empty).
         *
    ...
    /**
     * Implements an Iterator such that items in a Deque can be iterated over
     * from front to back.
     */
    private class DequeIterator implements Iterator<Item> {


        // Stores current Node in the Deque. (Returned by next()).
    ...
    /**
     * Returns an Iterator over items in a Deque, in order from front to back.
     */
    @Override
    ...
    public static void main(String[] args) {
        ...
        /* I put the unit test in a separate class "~/Tests/DequeTest". I wanted to
         * try a more formal approach to unit testing, but please let me know if
         * you would prefer me to just do the unit testing within the main method,
         * for the purposes of this course. */

        /* Also I added the @Override annotations but I wasn't sure if I should
         * have done that. I searched online and it seems like some people do it and
         * others don't. It seems to work either way at least for the scale of this
         * project.
         */
    }
}

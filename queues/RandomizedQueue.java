...
/**
 * Implements a queue such that items are added to the back but removed randomly.
 *
 * @param <Item> Generic non-primative data type to store in the RandomizedQueue.
...
public class RandomizedQueue<Item> implements Iterable<Item> {
    ...
    /**
     * Implements an Iterator such that items in a RandomizedQueue can be
    ...
    private class RandomizedQueueIterator implements Iterator<Item> {
        ...
        // Track number of remaining items in RandomizedQueue.
        ...
        public Item next() {
            ...
            // Swap next item with the last item in RandomizedQueue.
    ...
    public Item dequeue() {
        ...
        if (isEmpty()) {
            ...
            throw new NoSuchElementException("RandomizedQueue is currently empty.");
        }
    ...
    public static void main(String[] args) {
        ...
        // Unit test located at ~/Tests/RandomizedQueueTest.java

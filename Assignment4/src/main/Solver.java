...
public class Solver {
    ...
    private class SearchNode implements Comparable<SearchNode> {
        ...
        // src.main.Board stored at this node.
        ...
        // Store the previously visited src.main.Board.
         ...
         *
         * @param board The src.main.Board stored in this node.
     ...
     *
     * @param initial Starting src.main.Board for the game.
    ...
    public Solver(Board initial) {
        ...
        // Set initial search node as the given src.main.Board and add to PQ.
    ...
    public Iterable<Board> solution() {
        ...
        while (current.prev != null) {
            ...
            // Push current search node's src.main.Board onto deque.

package utils;/* *****************************************************************************
 *  Compilation:  javac-algs4 src.utils.SolverVisualizer.java
 *  Execution:    java-algs4 src.utils.SolverVisualizer filename
 *  Dependencies: src.main.Solver.java src.main.Board.java
 *
 *  This program takes the name of a file as a command-line argument.
 *  From that file, it
 *
 *    - Uses your src.main.Solver.java and src.main.Board.java programs to solve the
 *      sliding block puzzle defined by the input file.
 *    - Renders a graphical animation of your program's output.
 *    - Uses the manhattan() method in src.main.Board to display the
 *      Manhattan distance at each stage of the solution.
 *
 *  by Martin Round. September 2014 Coursera Algorithms, Part I course
 *
 *  % java-algs4 src.utils.SolverVisualizer puzzle07.txt
 *
 **************************************************************************** */
